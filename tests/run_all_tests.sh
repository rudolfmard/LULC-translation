...
python ../scripts/qualitative_evaluation.py --lcnames esawc,ecosg,mmt-weights-v2.0.ckpt --savefig --figdir tmp

python ../scripts/scores_from_inference.py --weights mmt-weights-v2.0.ckpt --npatches 200 --savefig --figdir tmp

python ../scripts/show_infres_ensemble.py --weights mmt-weights-v2.0.ckpt --u 0.82,0.11,0.47,0.34,0.65 --savefig --figdir tmp
...
python ../scripts/stats_on_labels.py --lcname mmt-weights-v2.0.ckpt --domainname montpellier_agglo --savefig --figdir tmp
...
python ../scripts/inference_and_merging.py --weights mmt-weights-v2.0.ckpt --domainname montpellier_agglo --output tmp
