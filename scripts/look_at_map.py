...
parser = argparse.ArgumentParser(
    ...
    epilog="Example: python -i look_at_map.py --lcname=EcoclimapSGplus --domainname=eurat --res=0.1 --no-fillsea",
)
...
figpath = os.path.join(
    mmt_repopath,
    "figures",
    f"{lcmap.__class__.__name__}_res{round(lcmap.res,4)}_{domainname}.png",
)
fig.savefig(figpath)
